...
\begin{document}
	...
	\begin{resumen}
		...
		Este estaría hecho con Unity y estarían implementados ocho idiomas cuyos teclados usen sus propios caracteres. Entre estos estarían el ruso, inglés , alemán, francés, español, griego, coreano y árabe.
	\end{resumen}
	\cleardoublepage
	...
	\begin{abstract}
		...
		Aquest estaria fet amb Unity i estarien implementats huit idiomes els teclats dels quals usen els seus propis caràcters. Entre ells estarien el rus, inglés, alemany, francés, espanyol, grec, coreà i àrab.
	\end{abstract}
	\cleardoublepage
	...
	\begin{resum}
		...
		This would be made with Unity and would implement eight languages whose keyboards use their own characters. These would include Russian, English, German, French, Spanish, Greek, Korean, and Arabic.
	\end{resum}
	\cleardoublepage
