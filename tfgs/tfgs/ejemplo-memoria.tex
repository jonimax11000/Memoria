...
\begin{document}
	...
	\begin{abstract}
		...
		Aquest estaria fet amb Unity i estarien implementats set idiomes els teclats dels quals usen els seus propis caràcters. Entre ells estarien el rus, inglés, alemany, francés, espanyol, grec i coreà.
	\end{abstract}
	\cleardoublepage
