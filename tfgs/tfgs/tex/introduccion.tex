...
\begin{enumerate}
	\item Para satisfacer necesidades específicas detectadas durante las prácticas en el Instituto de Robótica y Tecnologías de la Información y la Comunicación (IRTIC):
	\begin{itemize}
		\item La ausencia de teclados españoles para Realidad Virtual y Realidad Virtual.
	\end{itemize}

	\item Ofrecer una reacción competitiva mediante:
	\begin{itemize}
		\item Supporto intuitivo en 8 idiomas (español, inglés, francés, alemán, griego, ruso, coreano y árabe)

		\item Cambio rápido entre las distribuciones sin reiniciar la escena.
	\end{itemize}
	\item Garantizar habilidad para adaptarse a:
	
	\begin{itemize}
		\item cualquier proyecto en Unity que emplee la Realidad Virtual.
		\item Diversos aparatos de entrada (mandos VR, Hand Tracking)
	\end{itemize}
\end{enumerate}
